...
export const ADMIN_AUDIT_ACTION_JOB_SOURCE_SYNC_ACTIVE = 'job_source.sync_active';
...
export const ADMIN_AUDIT_ACTION_JOB_QUALITY_PURGE = 'job_quality.purge_inactive';

export const ADMIN_AUDIT_RESOURCE_JOB_SOURCE_SUBMISSION = 'JobSourceSubmission';
export const ADMIN_AUDIT_ACTION_SUBMISSION_APPROVE = 'job_source_submission.approve';
export const ADMIN_AUDIT_ACTION_SUBMISSION_REJECT = 'job_source_submission.reject';
